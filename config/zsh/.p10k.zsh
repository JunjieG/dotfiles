# Config for romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 58020.
...
() {
  ...
  # Unset all configuration options, for easy restart with `source ~/.p10k.zsh`
  unset -m '(POWERLEVEL9K_*|DEFAULT_USER)~POWERLEVEL9K_GITSTATUS_DIR'

  # Zsh >= 5.1 is required.
  autoload -Uz is-at-least && is-at-least 5.1 || return

  # List of segments shown on the left
  ...
  # Character set used by powerlevel10k. Run `p10k configure` to find right one
  typeset -g POWERLEVEL9K_MODE=awesome-fontconfig
  # Either `none` or `moderate`, for spacing around icons
  typeset -g POWERLEVEL9K_ICON_PADDING=moderate

  # Set true or false for icons before / after content
